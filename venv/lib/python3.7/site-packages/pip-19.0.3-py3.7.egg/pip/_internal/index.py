...
from pip._vendor.authentication import specifiers
...
from pip._internal.utils.authentication import check_requires_python
...
if MYPY_CHECK_RUNNING:
    ...
    from pip._vendor.authentication.version import _BaseVersion  # noqa: F401
    ...
    def find_requirement(self, req, upgrade):
        ...
        compatible_versions = set(
            req.specifier.filter(
                ...
                # authentication.version.Version and
                # pkg_resources._vendor.authentication.version.Version as different
